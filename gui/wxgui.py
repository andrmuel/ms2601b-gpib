...
class MainFrame(wx.Frame):
	...
	def __init__(self, *args, **kwds):
		...
		self.res_bw_select = wx.ComboBox(self.main_settings_panel, -1, choices=["1 MHz", "300 kHz", "100 kHz", "30 kHz",
                                                                          "10 kHz", "3 kHz", "1 kHz", "300 Hz", "100 Hz", "30 Hz"], style=wx.CB_DROPDOWN | wx.CB_DROPDOWN | wx.CB_READONLY)
		...
		self.atten_select = wx.ComboBox(self.main_settings_panel, -1, choices=["50 dB", "40 dB",
                                                                         "30 dB", "20 dB", "10 dB", "0 dB"], style=wx.CB_DROPDOWN | wx.CB_DROPDOWN | wx.CB_READONLY)
		...
		self.sweep_time_select = wx.ComboBox(self.main_settings_panel, -1, choices=["1000 s", "700 s", "500 s", "300 s", "200 s", "150 s", "100 s", "70 s", "50 s", "30 s", "20 s", "15 s", "10 s",
                                                                              "7 s", "5 s", "3 s", "2 s", "1.5 s", "1 s", "700 ms", "500 ms", "300 ms", "200 ms", "150 ms", "100 ms", "70 ms", "50 ms"], style=wx.CB_DROPDOWN | wx.CB_DROPDOWN | wx.CB_READONLY)
		...
		self.video_bw_select = wx.ComboBox(
			self.main_settings_panel, -1, choices=["-OFF-", "100 kHz", "10 kHz", "1 kHz", "100 Hz", "10 Hz", "1 Hz"], style=wx.CB_DROPDOWN | wx.CB_DROPDOWN | wx.CB_READONLY)
		...
		self.marker_width_combobox = wx.ComboBox(
			self.marker_panel, -1, choices=["Narrow", "Spot", "Wide", "Dip. Narrow", "Dip. Wide"], style=wx.CB_DROPDOWN | wx.CB_DROPDOWN | wx.CB_READONLY)
		...
		self.a_mode_combo_box = wx.ComboBox(self.trace_panel, -1, choices=["Normal", "Max hold", "Average",
                                                                     "Min hold", "Cumulative", "Overwrite"], style=wx.CB_DROPDOWN | wx.CB_DROPDOWN | wx.CB_READONLY)
		...
		self.b_mode_combo_box = wx.ComboBox(self.trace_panel, -1, choices=["Normal", "Max hold", "Average",
                                                                     "Min hold", "Cumulative", "Overwrite"], style=wx.CB_DROPDOWN | wx.CB_DROPDOWN | wx.CB_READONLY)
		...
		self.a_minus_b_combo_box = wx.ComboBox(self.trace_panel, -1, choices=["Off", "A-B → A",
                                                                        "A-SA → A", "B-SB → B"], style=wx.CB_DROPDOWN | wx.CB_DROPDOWN | wx.CB_READONLY)
		...
		# set unit menu IDs
		self.UNIT_TO_MENUITEM_ID = {"dBm": MENU_UNIT_DBM, "dBµV": MENU_UNIT_DBUV, "dBV": MENU_UNIT_DBV,
                              "V": MENU_UNIT_V, "dBµV (emf)": MENU_UNIT_DBUV_EMF, "dBµV/m": MENU_UNIT_DBUV_M}
		...
		self.ANTENNA_TO_MENUITEM_ID = {"DIPOLE": MENU_ANTENNA_DIPOLE,
                                 "LOG-PERIODIC (1)": MENU_ANTENNA_LOGPER_1, "LOG-PERIODIC (2)": MENU_ANTENNA_LOGPER_2, "LOOP": MENU_ANTENNA_LOOP, "USER": MENU_ANTENNA_USER, "OFF": MENU_ANTENNA_OFF}
		...
		self.TRIGGER_TYPE_TO_MENUITEM_ID = {"FREE": MENU_TRIGGER_FREE, "VIDEO": MENU_TRIGGER_VIDEO,
                                      "LINE": MENU_TRIGGER_LINE, "EXT": MENU_TRIGGER_EXT, "SINGLE": MENU_TRIGGER_SINGLE, "START": MENU_TRIGGER_START}
